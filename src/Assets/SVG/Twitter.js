  ...
  return (
    <div className="icon">
      <svg
        ...
        width="15.362"
        height="12.479"
        viewBox="0 0 15.362 12.479"
        fill={color}
      >
        <g
          id="Twitter_icon"
          data-name="Twitter icon"
          transform="translate(61.999 -54.441)"
        >
          <g
            id="Group_7"
            data-name="Group 7"
